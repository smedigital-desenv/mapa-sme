...
insert into public.escolas (codigo_inep, nome, email_institucional) values
  ('35000001', 'EMEF João da Silva', 'usuario@educacao.pmrp.sp.gov.br'),
  ('35000002', 'EMEI Maria Souza',  'usuario@educacao.pmrp.sp.gov.br');

-- 2) Perfis (e-mails autorizados). tipo: 'secretaria' | 'escola' | 'externo'
insert into public.perfis (email, nome, tipo) values
  ('usuario@educacao.pmrp.sp.gov.br', 'Gestor da EMEF João', 'escola'),
  ('usuario@educacao.pmrp.sp.gov.br', 'Técnico SME',         'secretaria');
...
where p.email = 'usuario@educacao.pmrp.sp.gov.br'
